...
.payment.cash{ background:#5cb85c; }
.payment.qris{ background:#f0ad4e; }
...
<aside class="sidebar" id="sidebar">
    ...
    <ul>
      ...
      <li class="active"><a href="{ route('tambah_menu')}"><img src="{{ asset('images/tambah.png') }}"><span>Tambah Menu</span></a></li>
...
<select name="kategori_id" id="makanan" disabled
style="display:none; width:100%; padding:10px; border-radius:8px; border:1px solid #ccc;">
...
<select name="kategori_id" id="minuman" disabled
style="display:none; width:100%; padding:10px; border-radius:8px; border:1px solid #ccc;">
  ...
  @endforeach
    ...
    @if($errors->any())
      ...
      <button type="submit"
      style="background:#2f5f9f; color:white; padding:10px 18px; border:none; border-radius:8px; cursor:pointer;">
        Simpan Menu
      </button>
